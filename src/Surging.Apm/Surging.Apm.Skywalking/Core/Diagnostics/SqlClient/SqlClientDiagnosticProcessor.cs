...
namespace Surging.Apm.Skywalking.Core.Diagnostics.SqlClient
{
    public class SqlClientTracingDiagnosticProcessor : ITracingDiagnosticProcessor
    {
        ...
        public void BeforeExecuteCommand([Property(Name = "Command")] SqlCommand sqlCommand)
        {
            ...
            context.Span.AddTag(Tags.DB_INSTANCE, sqlCommand.Connection.Database);
            context.Span.AddTag(Tags.DB_STATEMENT,  sqlCommand.CommandText);
        }
