...
namespace Surging.Apm.Skywalking.Core.Diagnostics.EntityFrameworkCore
{
    public class EntityFrameworkCoreTracingDiagnosticProcessor : ITracingDiagnosticProcessor
    {
        ...
        public void CommandExecuting([Object] CommandEventData eventData)
        {
            ...
            context.Span.AddTag(Tags.DB_INSTANCE, eventData.Command.Connection.Database);
            context.Span.AddTag(Tags.DB_STATEMENT, eventData.Command.CommandText);
